...
.search-bar{display:flex;align-items:center;gap:8px;background:var(--content-bg);border:1px solid var(--border);border-radius:10px;padding:8px 14px;width:clamp(180px,26vw,340px);transition:border-color .2s,box-shadow .2s}
...
.vac-tab.on{background:var(--green-mist);border-color:rgba(45,223,110,.3);color:var(--green-dark);font-weight:700}
...
.worker-name{font-size:13.5px;font-weight:600;color:var(--text);line-height:1.2}
...
.pn-title{font-family:'Syne',sans-serif;font-size:15px;font-weight:800;color:var(--text)}
...
.pn-wname{font-size:14px;font-weight:700;color:var(--text)}
...
.form-section{font-size:10.5px;font-weight:700;color:var(--text-soft);text-transform:uppercase;letter-spacing:.8px;padding-bottom:8px;border-bottom:1px solid var(--border);margin-bottom:4px}
.form-row{display:grid;grid-template-columns:1fr 1fr;gap:14px}
.form-row.g3{grid-template-columns:1fr 1fr 1fr}
.form-group{display:flex;flex-direction:column;gap:5px}
.form-group.full{grid-column:1/-1}
.form-label{font-size:11.5px;font-weight:600;color:var(--text-mid);letter-spacing:.3px}
...
.form-input[readonly]{background:#eef2ef;color:var(--green-dim);font-weight:700}
