      ...
      <div class="profile-wrap" id="profileWrap">
        <button class="profile-btn" onclick="toggleProfile()">
          ...
          <div class="profile-info">
            <span class="profile-name"><?php echo htmlspecialchars($nombres.' '.$apellidos)?></span>
            <span class="profile-role"><?php echo $rol_nombre?></span>
          </div>
          <svg class="profile-chevron" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"/></svg>
        </button>
        <div class="profile-dropdown" id="profileDropdown">
          <div class="profile-dropdown-head">
            <div class="profile-avatar-lg"><?php echo $inicial?></div>
            <div>
              <div style="font-size:13px;font-weight:600;color:var(--text)"><?php echo htmlspecialchars($nombres.' '.$apellidos)?></div>
              <div style="font-size:11px;color:var(--green-dim);margin-top:2px"><?php echo $rol_nombre?></div>
            </div>
          </div>
